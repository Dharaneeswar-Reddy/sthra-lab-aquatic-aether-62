  ...
  const researchAreas = [
    {
      ...
      items: [
        "Autonomous Underwater Vehicles (AUVs) for bathymetry and quality sensing",
        "Water Tunnel Inspection Systems for submerged civil infrastructure",
        "Surveillance-Capable USVs for lake health monitoring and environmental security",
        "ROVs for Close-Range Inspections in tanks, reservoirs, and pipelines"
      ]
    },
    {
      icon: Zap,
      ...
      items: [
        "Instability detection through environmental perception",
        "Development of real-time stability control algorithms for autonomous surface vessels (ASVs)"
      ]
    },
    {
      icon: Fish,
      ...
      items: [
        "Quiet, efficient swimming using soft fins (inspired by SoFi, DroidMantaRay)",
        "Designs that minimize disturbance in sensitive aquatic ecosystems",
        "Applications in aquafarms, coral studies, and ecologically safe exploration"
      ]
    },
    {
      icon: Plane,
      ...
      items: [
        "Tiltable-thruster aerial-aquatic drones",
        "Amphibious propulsion inspired by Velox robot and cuttlefish, using undulating fins to both swim and crawl"
      ]
    },
    {
      icon: Eye,
      ...
      items: [
        "Visual, inertial, depth, sonar, and pressure sensors",
        "Compact and low-power embedded implementations",
        "Capable of supporting GNSS-denied navigation, both indoor and underwater"
      ]
    },
    {
      icon: Brain,
      ...
      items: [
        ...
        "Adaptive control",
        "Learning-based decision-making in uncertain and dynamic conditions"
      ]
    },
    {
      icon: MapPin,
      ...
      items: [
        ...
        "Navigation in GPS-denied or confined industrial spaces"
      ]
    },
    {
      icon: Satellite,
      ...
      items: [
        "Inspired by Mars rovers and extra-terrestrial exploration",
        "Includes wheel-soil interaction, perception-based navigation, and terrain mapping"
      ]
    }
  ];
