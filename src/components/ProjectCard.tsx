...
export const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div className="academic-card overflow-hidden hover:shadow-lg transition-all duration-300 group">
      ...
      <div className="p-6">
        <h3 className="academic-subheading text-xl mb-3">
          {project.title}
        </h3>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {project.publications.map((pub, pubIndex) => (
              <span 
                key={pubIndex} 
                className="px-2 py-1 bg-muted text-xs rounded-md border text-muted-foreground"
              >
                {pub}
              </span>
            ))}
