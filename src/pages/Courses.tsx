        ...
        <section className="section-padding bg-gradient-to-b from-gray-50 to-white">
          <div className="container-width">
            <div className="text-center mb-12">
              <h1 className="academic-heading text-5xl text-blue-800">
                Courses
              </h1>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {courses.map((course, index) => <div key={index} className="academic-card p-6 hover:scale-105 transition-transform duration-200">
                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    {course.pdfAvailable && <button className="academic-button-secondary flex items-center justify-center space-x-2">
                        <Download size={16} />
