...
const Press = () => {
  const pressReleases = [
    {
      title: "STHRA Lab Receives $2.5M Grant for Revolutionary Underwater AI Research",
      date: "March 15, 2024",
      source: "University News",
      excerpt: "The National Science Foundation awarded STHRA Lab a major grant to develop next-generation AI navigation systems for autonomous underwater vehicles.",
    ...
    },
    {
      ...
      excerpt: "STHRA Lab unveils groundbreaking hybrid platform capable of seamless transitions between air and underwater operations.",
    ...
    },
    {
      ...
      excerpt: "Dr. Sarah Chen and her team at STHRA Lab are revolutionizing ocean exploration with cutting-edge autonomous systems.",
      image: "https://images.unsplash.com/photo-1559827260-dc66d52bef19?auto=format&fit=crop&w=800&q=80",
      category: "Research"
    },
    {
      title: "STHRA Lab Partners with Leading Marine Research Institute",
  ...
  const mediaKit = [
    ...
    {
      type: "Logo Package",
      description: "STHRA Lab logos in various formats and orientations",
      format: "SVG/PNG/EPS"
    },
    {
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Stay updated with the latest news, breakthroughs, and media coverage of STHRA Lab's research and innovations.
              </p>
            </div>
            ...
            <div className="text-center mt-16">
              ...
              <div className="bg-navy-800/50 border border-cyan-500/20 rounded-xl p-6 max-w-2xl mx-auto">
                <p className="text-gray-300 mb-4">
                  For media inquiries, interview requests, or additional information about STHRA Lab's research:
                </p>
                <div className="space-y-2">
                  <p className="text-cyan-400 font-medium">Dr. Sarah Chen, Principal Investigator</p>
                  <p className="text-gray-300">Email: media@sthralab.edu</p>
